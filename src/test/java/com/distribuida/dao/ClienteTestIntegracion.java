...
public class ClienteTestIntegracion {
    ...
    public void save(){
        Cliente cliente = new Cliente(
                ...
                , "Av. por ahi", "0985431057", "jtaipeo@correo.com");
    ...
    @Test
    public void update(){
        Optional<Cliente> cliente = clienteDAO.findById(43);
        assertTrue(cliente.isPresent(),"El cliente con id=43 debe de existir para ser actualizado");
